// --- Artwork Resolver ---
import { _CACHE, liveCache, USE_GC } from "./00-head.js";
...
export function getArtworkFor(item, view) {
...
export function getMedClass(med) {
  var m = med || 0;
...
export function chainImgErr(el) {
  if (!el) return;
...
/** @type {any} */ (window).checkImgLoaded = checkImgLoaded;
